...
function renderCategories() {
  ...
  categories.forEach(cat => {
    ...
    a.href = "#";
    a.addEventListener('click', (e) => { e.preventDefault(); currentFilter.category = cat.name; currentFilter.subcategory = ""; renderProducts(); sidebar.classList.remove('active'); });
    li.appendChild(a);
    if (cat.subcategories && cat.subcategories.length) {
      ...
      cat.subcategories.forEach(sub => {
        ...
        a2.textContent = "— " + sub;
        a2.href = "#";
        a2.addEventListener('click', (e) => { e.preventDefault(); currentFilter.category = cat.name; currentFilter.subcategory = sub; renderProducts(); sidebar.classList.remove('active'); });
        li2.appendChild(a2);
        ul.appendChild(li2);
      });
      li.appendChild(ul);
